...
var genSharedBadgeStyle = function genSharedBadgeStyle(token) {
  ...
  var statusPreset = _theme.PresetColors.reduce(function (prev, colorKey) {
  ...
  var statusRibbonPreset = _theme.PresetColors.reduce(function (prev, colorKey) {
    var darkColor = token[colorKey + "-6"];
  ...
  return _ref7 = {}, (0, _defineProperty2["default"])(_ref7, componentCls, (0, _extends9["default"])((0, _extends9["default"])({}, (0, _style.resetComponent)(token)), (_extends6 = {
    ...
    verticalAlign: 'top'
  }), _ref4)), _extends6))), (0, _defineProperty2["default"])(_ref7, "" + ribbonWrapperPrefixCls, {
    position: 'relative'
...
// ============================== Export ==============================
var _default = (0, _theme.genComponentStyleHook)('Badge', function (token) {
  ...
  var badgeToken = (0, _theme.mergeToken)(token, {
