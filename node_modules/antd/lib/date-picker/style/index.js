...
var genPickerStatusStyle = function genPickerStatusStyle(token) {
  ...
  return (0, _defineProperty2["default"])({}, componentCls, {
    '&-status-error&': (0, _defineProperty2["default"])({
      ...
      '&-focused, &:focus': (0, _extends5["default"])({}, (0, _style.genActiveStyle)((0, _theme.mergeToken)(token, {
...
var _default = (0, _theme.genComponentStyleHook)('DatePicker', function (token) {
  var pickerToken = (0, _theme.mergeToken)((0, _style.initInputToken)(token), initPickerPanelToken(token));
