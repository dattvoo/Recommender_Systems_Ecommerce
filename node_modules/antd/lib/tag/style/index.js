...
var genTagColorStyle = function genTagColorStyle(token) {
  return _theme.PresetColors.reduce(function (prev, colorKey) {
    var _extends2;
...
// ============================== Export ==============================
var _default = (0, _theme.genComponentStyleHook)('Tag', function (token) {
  ...
  var tagToken = (0, _theme.mergeToken)(token, {
