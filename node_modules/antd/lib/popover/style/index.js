...
var genColorStyle = function genColorStyle(token) {
  var componentCls = token.componentCls;
  return (0, _defineProperty2["default"])({}, componentCls, _theme.PresetColors.map(function (colorKey) {
    var _ref4;
...
var _default = (0, _theme.genComponentStyleHook)('Popover', function (token) {
  var colorBgElevated = token.colorBgElevated,
    colorText = token.colorText,
    wireframe = token.wireframe;
  var popoverToken = (0, _theme.mergeToken)(token, {
