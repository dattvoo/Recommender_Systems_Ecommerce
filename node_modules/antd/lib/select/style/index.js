...
var genSelectStyle = function genSelectStyle(token) {
  ...
  // ==                     Status                      ==
  // =====================================================
  genStatusStyle(componentCls, (0, _theme.mergeToken)(token, {
    borderHoverColor: token.colorPrimaryHover,
    outlineColor: token.controlOutline
  })), genStatusStyle(componentCls + "-status-error", (0, _theme.mergeToken)(token, {
    borderHoverColor: token.colorErrorHover,
    outlineColor: token.colorErrorOutline
  }), true), genStatusStyle(componentCls + "-status-warning", (0, _theme.mergeToken)(token, {
    borderHoverColor: token.colorWarningHover,
    outlineColor: token.colorWarningOutline
  }), true)];
};
// ============================== Export ==============================
var _default = (0, _theme.genComponentStyleHook)('Select', function (token, _ref10) {
  var rootPrefixCls = _ref10.rootPrefixCls;
  var selectToken = (0, _theme.mergeToken)(token, {
