...
var genDisabledStyle = function genDisabledStyle(token) {
  return {
    ...
    cursor: 'not-allowed',
    opacity: 1,
    '&:hover': (0, _extends6["default"])({}, genHoverStyle((0, _theme.mergeToken)(token, {
...
var genStatusStyle = function genStatusStyle(token) {
  ...
  return {
    '&-status-error:not(&-disabled):not(&-borderless)&': (0, _defineProperty2["default"])({
      ...
      '&:focus, &-focused': (0, _extends6["default"])({}, genActiveStyle((0, _theme.mergeToken)(token, {
...
function initInputToken(token) {
  // @ts-ignore
  return (0, _theme.mergeToken)(token, {
...
// ============================== Export ==============================
var _default = (0, _theme.genComponentStyleHook)('Input', function (token) {
