...
var genBaseStyle = function genBaseStyle(token) {
  ...
  // ====================== Tree ======================
  (0, _style2.genTreeStyle)(treePrefixCls, (0, _theme.mergeToken)(token, {
...
function useTreeSelectStyle(prefixCls, treePrefixCls) {
  return (0, _theme.genComponentStyleHook)('TreeSelect', function (token) {
    var treeSelectToken = (0, _theme.mergeToken)(token, {
