...
var generatorTooltipPresetColor = function generatorTooltipPresetColor(token) {
  ...
  return _theme.PresetColors.reduce(function (previousValue, currentValue) {
    var _previousValue;
...
var genTooltipStyle = function genTooltipStyle(token) {
  ...
  // Arrow Style
  (0, _placementArrow["default"])((0, _theme.mergeToken)(token, {
...
var _default = function _default(prefixCls, injectStyle) {
  var useOriginHook = (0, _theme.genComponentStyleHook)('Tooltip', function (token) {
    ...
    var TooltipToken = (0, _theme.mergeToken)(token, {
      // default variables
      tooltipMaxWidth: 250,
