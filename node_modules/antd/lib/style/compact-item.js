...
function compactItemBorderRadius(prefixCls, borderedElementCls) {
  ...
  return _ref2 = {}, (0, _defineProperty2["default"])(_ref2, "&-item:not(&-first-item):not(&-last-item) " + childCombinator, {
    borderRadius: 0
  }), (0, _defineProperty2["default"])(_ref2, '&-item&-first-item', (0, _defineProperty2["default"])({}, "& " + childCombinator + ", &" + prefixCls + "-sm " + childCombinator + ", &" + prefixCls + "-lg " + childCombinator, {
    borderStartEndRadius: 0,
    borderEndEndRadius: 0
  })), (0, _defineProperty2["default"])(_ref2, '&-item&-last-item', (0, _defineProperty2["default"])({}, "& " + childCombinator + ", &" + prefixCls + "-sm " + childCombinator + ", &" + prefixCls + "-lg " + childCombinator, {
