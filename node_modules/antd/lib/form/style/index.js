...
var genFormMotionStyle = function genFormMotionStyle(token) {
  ...
  var componentCls = token.componentCls,
    rootPrefixCls = token.rootPrefixCls;
  return (0, _defineProperty2["default"])({}, componentCls, (_componentCls = {}, (0, _defineProperty2["default"])(_componentCls, "." + rootPrefixCls + "-show-help", {
  ...
  }), (0, _defineProperty2["default"])(_componentCls, "." + rootPrefixCls + "-show-help-item", (_ref8 = {
    overflow: 'hidden',
    transition: "height " + token.motionDurationSlow + " " + token.motionEaseInOut + ",\n                     opacity " + token.motionDurationSlow + " " + token.motionEaseInOut + ",\n                     transform " + token.motionDurationSlow + " " + token.motionEaseInOut + " !important"
  }, (0, _defineProperty2["default"])(_ref8, "&-appear,\n          &-enter", {
  ...
  }), (0, _defineProperty2["default"])(_ref8, '&-leave-active', {
    transform: "translateY(-5px)"
  }), _ref8)), _componentCls));
};
var genHorizontalStyle = function genHorizontalStyle(token) {
  ...
  var componentCls = token.componentCls,
    ...
    rootPrefixCls = token.rootPrefixCls;
  return (0, _defineProperty2["default"])({}, componentCls + "-horizontal", (_ref10 = {}, (0, _defineProperty2["default"])(_ref10, formItemCls + "-label", {
    flexGrow: 0
  }), (0, _defineProperty2["default"])(_ref10, formItemCls + "-control", {
    flex: '1 1 0',
    // https://github.com/ant-design/ant-design/issues/32777
    // https://github.com/ant-design/ant-design/issues/33773
    minWidth: 0
  }), (0, _defineProperty2["default"])(_ref10, formItemCls + "-label." + rootPrefixCls + "-col-24 + " + formItemCls + "-control", {
    minWidth: 'unset'
  }), _ref10));
};
...
var makeVerticalLayout = function makeVerticalLayout(token) {
  ...
  var componentCls = token.componentCls,
    formItemCls = token.formItemCls;
  return _ref14 = {}, (0, _defineProperty2["default"])(_ref14, formItemCls + " " + formItemCls + "-label", (0, _extends5["default"])({}, makeVerticalLayoutLabel(token))), (0, _defineProperty2["default"])(_ref14, componentCls, (0, _defineProperty2["default"])({}, formItemCls, (0, _defineProperty2["default"])({
    flexWrap: 'wrap'
  }, formItemCls + "-label,\n          " + formItemCls + "-control", {
    flex: '0 0 100%',
    maxWidth: '100%'
...
var genVerticalStyle = function genVerticalStyle(token) {
  ...
  var componentCls = token.componentCls,
    formItemCls = token.formItemCls,
    rootPrefixCls = token.rootPrefixCls;
  return _ref19 = {}, (0, _defineProperty2["default"])(_ref19, componentCls + "-vertical", (0, _defineProperty2["default"])({}, formItemCls, (0, _defineProperty2["default"])({
    '&-row': {
      flexDirection: 'column'
    },
    '&-label > label': {
    ...
    width: '100%'
  }))), (0, _defineProperty2["default"])(_ref19, componentCls + "-vertical " + formItemCls + "-label,\n      ." + rootPrefixCls + "-col-24" + formItemCls + "-label,\n      ." + rootPrefixCls + "-col-xl-24" + formItemCls + "-label", (0, _extends5["default"])({}, makeVerticalLayoutLabel(token))), (0, _defineProperty2["default"])(_ref19, "@media (max-width: " + token.screenSMMax + "px)", (0, _extends5["default"])((0, _extends5["default"])({}, makeVerticalLayout(token)), (0, _defineProperty2["default"])({}, componentCls, (0, _defineProperty2["default"])({}, "." + rootPrefixCls + "-col-xs-24" + formItemCls + "-label", (0, _extends5["default"])({}, makeVerticalLayoutLabel(token)))))), (0, _defineProperty2["default"])(_ref19, "@media (max-width: " + token.screenSMMax + "px)", (0, _defineProperty2["default"])({}, componentCls, (0, _defineProperty2["default"])({}, "." + rootPrefixCls + "-col-sm-24" + formItemCls + "-label", (0, _extends5["default"])({}, makeVerticalLayoutLabel(token))))), (0, _defineProperty2["default"])(_ref19, "@media (max-width: " + token.screenMDMax + "px)", (0, _defineProperty2["default"])({}, componentCls, (0, _defineProperty2["default"])({}, "." + rootPrefixCls + "-col-md-24" + formItemCls + "-label", (0, _extends5["default"])({}, makeVerticalLayoutLabel(token))))), (0, _defineProperty2["default"])(_ref19, "@media (max-width: " + token.screenLGMax + "px)", (0, _defineProperty2["default"])({}, componentCls, (0, _defineProperty2["default"])({}, "." + rootPrefixCls + "-col-lg-24" + formItemCls + "-label", (0, _extends5["default"])({}, makeVerticalLayoutLabel(token))))), _ref19;
};
// ============================== Export ==============================
var _default = (0, _theme.genComponentStyleHook)('Form', function (token, _ref20) {
  var rootPrefixCls = _ref20.rootPrefixCls;
  var formToken = (0, _theme.mergeToken)(token, {
    formItemCls: token.componentCls + "-item",
    rootPrefixCls: rootPrefixCls
  });
  return [genFormStyle(formToken), genFormItemStyle(formToken), genFormMotionStyle(formToken), genHorizontalStyle(formToken), genInlineStyle(formToken), genVerticalStyle(formToken), (0, _motion.genCollapseMotion)(formToken), _motion.zoomIn];
});
